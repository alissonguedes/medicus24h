...
class FuncionarioModel extends Model
{
	...
	public function getFuncionarios($data = null)
	{
		...
		$get = $this->select(
			...
			DB::raw('(SELECT id_especialidade FROM tb_medico_especialidade WHERE tb_medico_especialidade.id_funcionario = tb_funcionario.id) AS especialidade'),
	...
	public function cadastraFuncionario(Request $post)
	{
		...
		$id_empresa_departamento = null; // $id_empresa_departamento = $this->select('id')->from('tb_departamento_empresa')->where('id_empresa', $id_empresa)->where('id_departamento', $id_departamento)->first()->id;
