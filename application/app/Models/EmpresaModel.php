...
class EmpresaModel extends AppModel
{
	...
	public function getClinicas($request = null, $medico = true)
	{
		...
		if ($medico) {
			...
			$get->join('tb_medico AS M', 'M.id_funcionario', 'MC.id_medico');
		}
	...
	public function getEmpresasComDepartamento()
	{
		...
		return $this->select('tb_empresa.id', 'tb_empresa.nome_fantasia', 'tb_empresa.titulo')
			...
			->where('tb_empresa.status', '1')
			->where('tb_departamento_empresa.status', '1')
			->get();
	...
	public function getDepartamentos($id_empresa)
	{
		...
		$get = $this->select('tb_departamento.id', 'tb_departamento.titulo', 'tb_departamento.descricao', 'tb_departamento.status')
			->distinct(true)
			->from('tb_departamento')
			->join('tb_departamento_empresa', 'tb_departamento_empresa.id_departamento', 'tb_departamento.id', 'right');

		if (!empty($id_empresa)) {
			$get = $get->where('tb_departamento_empresa.id_empresa', $id_empresa);
		}
