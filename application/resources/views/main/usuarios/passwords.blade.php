				...
				<div class="col s12 m12 l12">
					...
					<div class="row">
						<div class="col s12 mb-3">
							<h3 class="mt-1">Alterar Senha</h3>
						</div>
					</div>
					...
					<form action="{{ route('main.cadastro.paciente') }}" method="post" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off" data-autoinitialize="false">
						...
						<div class="row">
							<div class="col s12">
								<div class="input-field">
									...
									<input type="password" name="password" placeholder="Informe a nova senha" autofocus>
						...
						<div class="row">
							<div class="col s12">
								<div class="input-field">
									<i class="material-icons prefix">password</i>
									<input type="password" name="pconfirm" placeholder="Confirme a senha" autofocus>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col s12 mt-3">
								<button type="submit" class="btn right btn-large col s12 flex teal darken-1 waves-effect border-round" data-toggle="Salvar">
									<span class="mr-1">Atualizar senha</span>
