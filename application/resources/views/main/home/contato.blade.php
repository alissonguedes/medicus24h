...
<div class="container mt-8 pt-6 pb-6">
	<div class="row">
		...
		<div class="col s12 m6 l6">
			<form id="form" action="{{ route('main.contact') }}" method="post" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
				...
				<div class="row">
					...
					<div class="col s6 m6 l6">
						<div class="input-field bordered">
							<input type="text" name="telefone" data-mask="phone" maxlength="15" placeholder="Seu telefone">
						</div>
					</div>
				</div>
				<div class="row">
