								...
								<tr>
									<td style="padding: 0 0 50px;">
										<table align="center" bgcolor="#fff" style="border-radius: 24px;">
											...
											<tr>
												<td style="padding: 5px 20px;">
													Olá, <strong style="">{{ $request->nome }}</strong>! Você está recebendo este e-mail porque foi cadastradoi no Sistema Clínica Médicus24h.
												</td>
											</tr>
											<tr>
												<td style="padding: 5px 20px;">
													Para criar sua senha, por favor, utilize este <a href="{{ url('/password/reset', $request->token) }}">Link</a>.
													<br>
													O seu token tem validade máxima de {{ convert_time($request->ttl) }}.
												</td>
											</tr>
											{{-- <tr>
