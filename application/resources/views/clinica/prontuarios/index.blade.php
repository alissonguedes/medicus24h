...
@section('prev-url', go('clinica.pacientes.index'))
...
@section('main')
	...
	<div class="container prontuario no-padding">
		...
		<div class="row">
			...
			<div class="col s3 no-padding z-depth-2" style="position: relative; z-index: 993;">
			...
			<div class="col s9 no-padding">
				...
				<div class="container pt-2 pr-4 scroller" style="height: calc(100vh - 150px)">
