            ...
            <form action="{{ go('clinica.pacientes.post') }}" method="post" enctype="multipart/form-data" autocomplete="off" novalidate>
                ...
                <div class="card">
                    ...
                    <div class="card-content no-padding">
                        ...
                        <div class="card-body fixed-height border-top scroller pt-3 pb-4" data-hide-x="true">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col s12 m4 l4">
                                                        <div class="input-field">
                                                            ...
                                                            @endphp
                                                            <input type="text" name="matricula" id="matricula" value="{{ $matricula ?? null }}" autocapitalize="on">
                                                            <small class="info grey-text">
                                                                Em branco, será gerado automaticamente.
                                                            </small>{{-- <div class="input-label readonly">
@if(isset($paciente))
																	{{ $paciente->matricula }}
                                                            @else
                                                    ...
                                                    <div class="col s12">
                                                        <div class="input-field">
                                                            ...
                                                            <select name="id_tipo_convenio">
                                                                ...
                                                                @if($tipo_planos->count() > 0)
                                                                @foreach($tipo_planos as $tipo)
                                                                <option value="{{ $tipo->id }}" @if(isset($paciente) && $tipo->id === $paciente->id_tipo_convenio) selected="selected" @endif>{{ $tipo->descricao }}</option>
                                                                @endforeach
                                                                @endif
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col s6">
                                                        <div class="input-field">
                                                            ...
                                                            <select name="id_acomodacao">
                                                                ...
                                                                <option value="{{ $acomodacao->id }}" @if(isset($paciente) && $acomodacao->id === $paciente->id_acomodacao) selected="selected" @endif>{{ $acomodacao->descricao }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col s6">
                                                                    <select name="validade_ano" id="ano">
                                                                        ...
                                                                        @for($i = date('Y'); $i <= date('Y') + 20; $i ++) <option value="{{ $i }}" @if($i==$ano) selected="selected" @endif>{{ $i }}</option>
                                                                            @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
