...
@if ($pacientes->total() > 0)
	...
	@if (request()->get('query'))
		<div class="row">
			<div class="col s12">
				<h6>{{ $pacientes->total() }} @if ($pacientes->total() > 1)
					...
					<div class="card-content white-text">
						<div class="foto-paciente">
							...
							<p>
								...
								<a href="#"><i class="material-icons-outlined left">credit_card</i>{{ $paciente->matricula ?? 'Não informado' }}</a>
							</p>
							<div class="clear"></div>
						</div>
						<div class="contato">
						...
						<div class="acoes flex flex-center mt-5">
							<button data-href="{{ go('clinica.pacientes.{id_paciente}.prontuarios', $paciente->id) }}" name="id" id="{{ $paciente->id }}" class="waves-effect gradient-45deg-deep-orange-orange center-align icon-background circle white-text z-depth-3 mx-auto border-0 " data-tooltip="Prontuário">
