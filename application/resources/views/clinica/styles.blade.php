...
<link rel="stylesheet" media="screen" href="{{ asset('assets/plugins/font-awesome/6.2.0/css/all.css') }}">
...
<link rel="stylesheet" media="screen" href="{{ asset('assets/styles/site/materialize.min.css') }}">
<link rel="stylesheet" media="screen" href="{{ asset('assets/styles/site/materialize.css') }}">
