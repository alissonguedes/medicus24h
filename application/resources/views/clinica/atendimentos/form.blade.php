...
@section('main')
	...
	<div class="container">
		...
		<div class="col s12 l3">
			...
			<div id="atendimento" class="sidenav rightside-navigation grey lighten-3 z-depth-2 pt-2 pl-1 pr-1 animated fadeInRight" style="transform: translateX(-0%); width: 260px;" data-position="right">
