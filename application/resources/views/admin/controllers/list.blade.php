...
@if ($controllers->total() > 0)
	...
	@foreach ($controllers as $row)
		<div class="grid-row" data-trigger="modal" data-target="modal_controller" data-id="{{ $row->id }}" data-href="{{ route('admin.controllers.edit', $row->id) }}" data-disabled="true">
			<div class="grid-col">
				<label>
			...
			<div class="grid-col left-align">
				<button type="button" class="btn btn-small btn-edit btn-floating waves-effect blue-text transparent" data-trigger="modal" data-target="modal_controller" data-id="{{ $row->id }}" data-href="{{ route('admin.controllers.edit', $row->id) }}" data-disabled="true">
