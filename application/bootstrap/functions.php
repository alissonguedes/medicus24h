...
if (!function_exists('mailbox')) {
	...
	function mailbox()
	{
		...
		$mailbox = new Mailbox(
			'{mail.medicus24h.com.br:993/imap/ssl}INBOX', // IMAP server and mailbox folder
			'atendimento@medicus24h.com.br', // Username for the before configured mailbox
			'8]NtvRg+~!tu', // Password for the before configured username
